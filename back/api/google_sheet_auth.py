...
# Store the form ID (update this to the latest form ID from form.ipynb)
FORM_ID = '1yDf7vd5wLaPhm30IiGKTkPw4s5spb3Xlm86Li81YDXI'
...
def get_registered_users(force_update=False):
...
def is_user_registered(email):
    ...
    if username in ADMIN_USERS:
        return True
    registered_emails = get_registered_users()
